...
public class MathSolver {
	public String evaluate(SyntaxNode node, VariableContext context) throws EvaluationException {
	...
	private int evaluateExpression(Expression expression, VariableContext context) throws EvaluationException {
	...
	private int evaluateDesignator(Designator designator, VariableContext context) throws EvaluationException {
		try {
	...
	private int evaluateUnaryExpression(UnaryExpression expression, VariableContext context) throws EvaluationException {
	...
	private int evaluateBinaryExpression(BinaryExpression expression, VariableContext context) throws EvaluationException {
		Operator operator = expression.getOperator();
